...
#' }
praat_voice_tremor_opt <- function(listOfFiles,
                                   beginTime = 0,
                                   endTime = 0,
...
attr(praat_voice_tremor_opt, "outputType") <- c("list")
attr(praat_voice_tremor_opt, "ext") <- c("pvt")
attr(praat_voice_tremor_opt, "tracks") <- c("FCoM", "FTrC", "FMoN", "FTrF [Hz]", "FTrI [%]",
