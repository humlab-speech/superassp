...
#' quality \insertCite{kane2011peakslope}{superassp}. Captures similar information to
...
#' @usage trk_peakslope(listOfFiles, beginTime = 0, endTime = 0, toFile = FALSE, explicitExt = "psl", outputDirectory = NULL, verbose = TRUE)
