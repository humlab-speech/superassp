...
#' )
#' }
praat_sauce_opt <- function(listOfFiles,
                            beginTime = NULL,
                            endTime = NULL,
                            windowShift = 5.0,
                            windowSize = 25,
...
attr(praat_sauce_opt, "outputType") <- c("data.frame")
attr(praat_sauce_opt, "ext") <- c("psa")
attr(praat_sauce_opt, "tracks") <- c("t", "f0", "F1", "F2", "F3", "B1", "B2", "B3",
