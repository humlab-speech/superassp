...
All functions are fully self-contained (bundled C/C++ libraries; no external installs, including for
Praat-backed functions such as `trk_formant_burg`, `trk_praatsauce`, `lst_pharyngeal`, `lst_voice_tremor`,
