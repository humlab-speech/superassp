...
test_that("trk_pitch_rapt() wrapper works with single file", {
  skip_if_not_installed("superassp")
  ...
  result <- superassp::trk_pitch_rapt(test_wav, toFile = FALSE, verbose = FALSE)
...
test_that("trk_pitch_swipe() wrapper works with single file", {
  skip_if_not_installed("superassp")

  test_wav <- system.file("samples", "sustained", "a1.wav", package = "superassp")
  skip_if(test_wav == "", "Test file not found")

  result <- superassp::trk_pitch_swipe(test_wav, toFile = FALSE, verbose = FALSE)
...
test_that("trk_pitch_reaper() wrapper works with single file", {
  skip_if_not_installed("superassp")

  test_wav <- system.file("samples", "sustained", "a1.wav", package = "superassp")
  skip_if(test_wav == "", "Test file not found")

  result <- superassp::trk_pitch_reaper(test_wav, toFile = FALSE, verbose = FALSE)
...
test_that("trk_pitch_dio() wrapper works with single file", {
  skip_if_not_installed("superassp")

  test_wav <- system.file("samples", "sustained", "a1.wav", package = "superassp")
  skip_if(test_wav == "", "Test file not found")

  result <- superassp::trk_pitch_dio(test_wav, toFile = FALSE, verbose = FALSE)
...
test_that("trk_pitch_harvest() wrapper works with single file", {
  skip_if_not_installed("superassp")

  test_wav <- system.file("samples", "sustained", "a1.wav", package = "superassp")
  skip_if(test_wav == "", "Test file not found")

  result <- superassp::trk_pitch_harvest(test_wav, toFile = FALSE, verbose = FALSE)
...
test_that("R wrappers work with custom F0 range", {
  ...
  # Test with female voice range
  result_rapt <- superassp::trk_pitch_rapt(test_wav, minF = 100, maxF = 500,
                                  toFile = FALSE, verbose = FALSE)
  expect_s3_class(result_rapt, "AsspDataObj")

  result_swipe <- superassp::trk_pitch_swipe(test_wav, minF = 100, maxF = 500,
                                    toFile = FALSE, verbose = FALSE)
  expect_s3_class(result_swipe, "AsspDataObj")

  result_harvest <- superassp::trk_pitch_harvest(test_wav, minF = 80, maxF = 350,
                                        toFile = FALSE, verbose = FALSE)
...
test_that("R wrappers work with time windowing", {
  ...
  result <- superassp::trk_pitch_rapt(test_wav, beginTime = 0.1,
...
test_that("R wrappers can write to file", {
  ...
  n_written <- superassp::trk_pitch_rapt(test_wav, toFile = TRUE,
...
test_that("R wrappers handle non-WAV files via av package", {
  ...
  result <- superassp::trk_pitch_rapt(temp_mp3, toFile = FALSE, verbose = FALSE)
...
test_that("R wrapper error handling works correctly", {
  ...
  expect_error(
    superassp::trk_pitch_rapt(NULL, toFile = FALSE),
    "No input files specified"
  )

  expect_error(
    superassp::trk_pitch_swipe(character(0), toFile = FALSE),
    "No input files specified"
  )
})
