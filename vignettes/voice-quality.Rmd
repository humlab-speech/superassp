...
# lst_vq() is backed by the optional, GitHub-only 'pladdrr' package. Chunks
# that call it are skipped when it is absent, so the vignette still builds on
# machines (CRAN, win-builder) that do not have pladdrr installed.
