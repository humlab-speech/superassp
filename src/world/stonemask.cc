...
// Wrapped in namespace sptk::world::. The original include of world/fft.h
// is replaced by world/fft_world.h (SPTK rename). All unqualified calls to
// fft_execute(), InitializeForwardRealFFT(), matlab_round() etc. resolve to
// sptk::world:: implementations compiled from SPTK/third_party/WORLD/.
//-----------------------------------------------------------------------------
#include "stonemask.h"
