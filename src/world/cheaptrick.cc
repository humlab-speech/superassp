...
// Wrapped in namespace sptk::world:: so that unqualified calls to cdft(),
// rdft(), InitializeForwardRealFFT() etc. resolve to the implementations
// already compiled in src/SPTK/third_party/WORLD/ (also in sptk::world::).
//-----------------------------------------------------------------------------
