...
bool WaveIO::ReadAudioData(int32_t wave_start,
  ...
  switch (coding_type_) {
    ...
    default:
      REprintf("WaveIO:ReadAudioData: unknown coding type %d",
              coding_type_);
  }
  return false;
}
  ...
  switch (coding_type_) {
    ...
    case ULAW8:
      ...
      REprintf("WaveIO:ReadAudioData: unknown coding type %d",
              coding_type_);
    default:
      REprintf("WaveIO: coding type not supported %d", coding_type_);
      return false;
  }
  return false;
}
...
bool WaveIO::ReadHeader(FileResource *fr,
  ...
  switch (coding_type_) {
    ...
    default:
      REprintf("WaveIO:ReadHeader: unknown coding type %d",
              coding_type_);
  }
  return false;
}
...
bool WaveIO::Initialize(WaveCodingType coding_type) {
  ...
  switch (coding_type_) {
    ...
    default:
      REprintf("WaveIO:WaveIO: unknown coding type %d", coding_type_);
      return false;
  }
}
