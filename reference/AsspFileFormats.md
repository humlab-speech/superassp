...
list of possibly useful file formats for AsspDataObj corresponding to
the first element of the fileInfo attribute
...
| XASSP | 4 | xassp ASCII |
| IPDS_M | 5 | labels in IPdS `MIX' format \cr IPDS_S \tab 6\tab labels in IPdS `SAMPA' format |
...
| SND | 15 | NeXT version of `SND' format \cr AU \tab 15\tab Sun version of `SND' format |
