...
- [`get_definedtracks()`](https://humlab-speech.github.io/superassp/reference/get_definedtracks.md)
  : Get available tracks for a function or an SSFF file
- [`get_extension()`](https://humlab-speech.github.io/superassp/reference/get_extension.md)
  : Get the (default) extension for an SSFF producing function or a
  signal file
- [`get_outputType()`](https://humlab-speech.github.io/superassp/reference/get_outputType.md)
  : Get the return format of a wrassp/superassp speech signal processing
  function
...
- [`superassp_summary()`](https://humlab-speech.github.io/superassp/reference/superassp_summary.md)
