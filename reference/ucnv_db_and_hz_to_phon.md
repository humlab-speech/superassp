...
Converts sound pressure level (dB) at a given frequency to loudness
level (phon) according to ISO 226:2023 equal-loudness-level contours.
...
**Vectorization**: Both spl_db and freq_hz can be vectors. If both are
