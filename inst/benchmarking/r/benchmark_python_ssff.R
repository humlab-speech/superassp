...
if(exists("trk_pitch_swipe") && exists("swipe_opt")) {
  # Test consistency
...
if(exists("trk_pitch_rapt") && exists("rapt_opt")) {
  # Test consistency
...
cat("  ✓ Consistent interface with trk_formant_forest() template\n")
